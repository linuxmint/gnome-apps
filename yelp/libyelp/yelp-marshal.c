...
/* VOID:OBJECT,BOXED (./yelp-marshal.list:1) */
void
yelp_marshal_VOID__OBJECT_BOXED (GClosure     *closure,
...
/* BOOLEAN:OBJECT (./yelp-marshal.list:2) */
void
yelp_marshal_BOOLEAN__OBJECT (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
